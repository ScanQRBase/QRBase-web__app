            ...
            <div className="w-full transition-transform duration-300">
                <div className="flex flex-col items-center">
                    <div className="flex flex-col items-center mb-4">
                        <FaTrophy style={{ color: partnerData.primaryColor }} className="text-3xl mb-1" />
                    ...
                    <div className="relative w-[320px] h-[320px] md:w-[440px] md:h-[440px] border-2 border-gray-300 rounded-lg grid grid-cols-3 grid-rows-3 qrCube">
                        {piecesState.map((piece, index) => (
                            <div
                                key={index}
                                className={`relative border border-gray-300 group ${piece.pulse ? `animate-pulse border-2 border-[${partnerData.primaryColor}]` : ""
                                    }`}
                            >
                                {piece.image ? (
                                    <>
                    ...
                    {isCompleted ? (
                        ...
                        <div className="flex items-center space-x-2 border border-gray-500/50 dark:border-gray-400/50 px-4 py-1 rounded-full mt-6 mb-2">
